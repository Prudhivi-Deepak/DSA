...
function equalPasswords(formControl: AbstractControl){
...
export class SignupComponent {
  ...
  form = new FormGroup({
    ...
    address: new FormGroup({
      ...
      postalCode: new FormControl('', { validators: [Validators.required, Validators.minLength(5), Validators.maxLength(5)] }),
