...
System.out.println(name + " is performing an action."); -> It is for performAction method
System.out.println(name + " arm picking an item."); -> It is for pickItem method
System.out.println("Processor analyzing the data."); -> It is for process method
System.out.println(name + " sensor detecting obstacles."); -> It is for sense method
System.out.println(name + " executing a custom task."); -> It is for execute method
